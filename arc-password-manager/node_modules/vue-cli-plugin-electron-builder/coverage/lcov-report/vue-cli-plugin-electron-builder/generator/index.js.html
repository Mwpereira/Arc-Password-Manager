...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">vue-cli-plugin-electron-builder/generator</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (devtoolsExtensionsBroken) {
<span class="cstat-no" title="statement not covered" >    warn('Devtools extensions are broken in Electron 6.0.0 and greater')</span>
