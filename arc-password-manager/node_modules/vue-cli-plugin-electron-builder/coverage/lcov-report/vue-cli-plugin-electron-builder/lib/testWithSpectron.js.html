...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">vue-cli-plugin-electron-builder/lib</a> testWithSpectron.js
    </h1>
    <div class='clearfix'>
...
module.exports = (options = {}) =&gt;
  new Promise(async (resolve, reject) =&gt; {
    ...
    child.on('error', <span class="fstat-no" title="function not covered" >er</span>r =&gt; {
